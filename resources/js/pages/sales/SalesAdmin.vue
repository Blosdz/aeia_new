...
import DropdownAction from './SalesTeamDropDown.vue'
                    ...
                    <CardContent>
                      <div class="gap-y-1.5 p-3 flex flex-row items-center justify-between space-y-0 pb-2 gap-5">
                        <Card class="w-[100%]  bg-muted">
                          <CardHeader>  
                            <div class="text-2xl font-bold">Planes Vendidos</div>
                            <div class="text-lg font-bold"> $15,231.89 </div>
                            <div class="text-2xl font-bold"> Clientes Registrados</div>
